  ...
  'inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        'outline-warning':
          'border border-yellow-500 text-yellow-500 bg-transparent hover:bg-yellow-500 hover:text-white',
        'outline-info':
        ...
        'outline-pink':
          'border border-pink-500 text-pink-500 bg-transparent hover:bg-pink-500 hover:text-white',
        'outline-orange':
        ...
        'outline-cyan':
          'border border-cyan-500 text-cyan-500 bg-transparent hover:bg-cyan-500 hover:text-white',
        'outline-rose':
          'border border-rose-500 text-rose-500 bg-transparent hover:bg-rose-500 hover:text-white',
        'outline-emerald':
          'border border-emerald-500 text-emerald-500 bg-transparent hover:bg-emerald-500 hover:text-white',
        'outline-amber':
          'border border-amber-500 text-amber-500 bg-transparent hover:bg-amber-500 hover:text-white',
        'outline-lime':
          'border border-lime-500 text-lime-500 bg-transparent hover:bg-lime-500 hover:text-white',
        'outline-violet':
          'border border-violet-500 text-violet-500 bg-transparent hover:bg-violet-500 hover:text-white',
        'outline-sky':
          'border border-sky-500 text-sky-500 bg-transparent hover:bg-sky-500 hover:text-white',
      },
      size: {

...
@Component({
  selector: 'lib-breadcrumb-separator',
  standalone: true,
  imports: [CommonModule],
  template: `
...
@Component({
  selector: 'lib-breadcrumb-ellipsis',
  standalone: true,
  template: `
...
@Component({
  selector: 'lib-breadcrumb-complete',
  standalone: true,
      ...
      <lib-breadcrumb-list>
        <ng-container *ngFor="let item of visibleItems; let last = last; let i = index">
          <lib-breadcrumb-item>
            ...
            <lib-breadcrumb-page *ngIf="last">
              {{ item.label }}
            </lib-breadcrumb-page>
          </lib-breadcrumb-item>
          
          <lib-breadcrumb-separator *ngIf="!last"></lib-breadcrumb-separator>
        </ng-container>
        
        <!-- Show ellipsis if items are collapsed -->
        <ng-container *ngIf="hasCollapsedItems">
          <lib-breadcrumb-item>
            <lib-breadcrumb-ellipsis></lib-breadcrumb-ellipsis>
          </lib-breadcrumb-item>
          <lib-breadcrumb-separator></lib-breadcrumb-separator>
        </ng-container>
      </lib-breadcrumb-list>
    </nav>
  `,

...
export class SEOService {
  ...
  getHomepageSEO(): SEOData {
    return {
      ...
      description: 'Build stunning Angular applications with our comprehensive component library. 43+ components, TypeScript support, Tailwind CSS integration, and full accessibility compliance.',

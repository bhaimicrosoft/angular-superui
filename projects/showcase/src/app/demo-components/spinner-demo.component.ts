...
import { Spinner, SpinnerType, SpinnerVariant } from '@lib/spinner';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, Spinner, Button, Badge, Card],
  ...
  template: `
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-blue-900/20 dark:to-indigo-900/20">
      ...
      <section class="relative overflow-hidden">
        ...
        <div class="absolute top-40 right-20 w-16 h-16 bg-white/10 rounded-full animate-float animation-delay-2000"></div>
        <div class="absolute bottom-20 left-1/4 w-12 h-12 bg-white/10 rounded-full animate-float animation-delay-4000"></div>
        ...
        <div class="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-32">
          <div class="text-center">
            <div class="mx-auto max-w-4xl">
              ...
              <p class="mx-auto mt-6 max-w-2xl text-lg leading-8 text-blue-100 sm:text-xl animate-slide-in-up animation-delay-400">
                    ...
                    <div>
                      ...
                      <div class="grid grid-cols-2 md:grid-cols-6 gap-6">
                        <div class="flex flex-col items-center space-y-2">
                          <Spinner size="lg" variant="primary" type="spinner" [forceReducedMotion]="respectReducedMotion()"></Spinner>
                          <span class="text-xs text-white/80">Classic</span>
                        </div>
                        <div class="flex flex-col items-center space-y-2">
                          <Spinner size="lg" variant="success" type="dots" [forceReducedMotion]="respectReducedMotion()"></Spinner>
                          <span class="text-xs text-white/80">Dots</span>
                        </div>
                        <div class="flex flex-col items-center space-y-2">
                          <Spinner size="lg" variant="warning" type="pulse" [forceReducedMotion]="respectReducedMotion()"></Spinner>
                          <span class="text-xs text-white/80">Pulse</span>
                        </div>
                        <div class="flex flex-col items-center space-y-2">
                          <Spinner size="lg" variant="pink" type="bounce" [forceReducedMotion]="respectReducedMotion()"></Spinner>
                          <span class="text-xs text-white/80">Bounce</span>
                        </div>
                        <div class="flex flex-col items-center space-y-2">
                          <Spinner size="lg" variant="purple" type="bars" [forceReducedMotion]="respectReducedMotion()"></Spinner>
      ...
      <main class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div class="rounded-xl border bg-card p-6 shadow-sm lg:p-8">
            <div class="space-y-8">
              ...
              <div class="space-y-4">
                ...
                <div class="flex items-center justify-center rounded-lg border border-dashed border-border bg-muted/30 py-12">
                  <Spinner
                    [size]="selectedSize()"
        ...
        <!-- Call to Action -->
        <section class="rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 px-6 py-16 text-center text-white lg:px-8">
